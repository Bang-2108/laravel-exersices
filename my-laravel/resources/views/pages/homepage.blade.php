				...
				<div class="bannercontainer" >
					<div class="banner" >
						<ul>
							@foreach ($slide as $sl )
								<li>
									<img src="{{asset('source/image/slide/banner1.jpg') }}" alt="banner">
								</li>
							@endforeach
						</ul>
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img src="{{asset('source/image/product/1234.jpg') }}" alt="product"></a>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="product.html"><img src="{{asset('source/image/product/1234.jpg') }}" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
